 ...
 * 
 * @param config The d_p_adc_oneshot_cfg_handle_t
 * 
 ...
 * 
 * @note It have to be call with previous verification
 * 
 * @param config The d_p_adc_oneshot_cfg_handle_t
 * 
 * @return esp_err_t ESP_OK
 ...
 * 
 * @note Another low level function have to use the need_handle flag to erase the adc handle with the adc oneshot api
 * 
