...
#define D_P_ADC_ONESHOT_CONST_GPIO_39_ADC_CHANNEL ADC_CHANNEL_3
#define D_P_ADC_ONESHOT_CONST_GPIO_38_ADC_CHANNEL ADC_CHANNEL_2
#define D_P_ADC_ONESHOT_CONST_GPIO_37_ADC_CHANNEL ADC_CHANNEL_1
#define D_P_ADC_ONESHOT_CONST_GPIO_36_ADC_CHANNEL ADC_CHANNEL_0
#define D_P_ADC_ONESHOT_CONST_GPIO_35_ADC_CHANNEL ADC_CHANNEL_7
#define D_P_ADC_ONESHOT_CONST_GPIO_34_ADC_CHANNEL ADC_CHANNEL_6
#define D_P_ADC_ONESHOT_CONST_GPIO_33_ADC_CHANNEL ADC_CHANNEL_5
#define D_P_ADC_ONESHOT_CONST_GPIO_32_ADC_CHANNEL ADC_CHANNEL_4

// ADC UNIT 2 (ESP32 Classic)

#define D_P_ADC_ONESHOT_CONST_GPIO_27_ADC_CHANNEL ADC2_CHANNEL_7
#define D_P_ADC_ONESHOT_CONST_GPIO_26_ADC_CHANNEL ADC2_CHANNEL_9
#define D_P_ADC_ONESHOT_CONST_GPIO_25_ADC_CHANNEL ADC2_CHANNEL_8
#define D_P_ADC_ONESHOT_CONST_GPIO_15_ADC_CHANNEL ADC2_CHANNEL_3
#define D_P_ADC_ONESHOT_CONST_GPIO_14_ADC_CHANNEL ADC2_CHANNEL_6
#define D_P_ADC_ONESHOT_CONST_GPIO_12_ADC_CHANNEL ADC2_CHANNEL_5
#define D_P_ADC_ONESHOT_CONST_GPIO_13_ADC_CHANNEL ADC2_CHANNEL_4
#define D_P_ADC_ONESHOT_CONST_GPIO_4_ADC_CHANNEL ADC2_CHANNEL_0
#define D_P_ADC_ONESHOT_CONST_GPIO_2_ADC_CHANNEL ADC2_CHANNEL_2
#define D_P_ADC_ONESHOT_CONST_GPIO_0_ADC_CHANNEL ADC2_CHANNEL_1
